          ...
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                <h2>Projects</h2>
                <p>"I have developed secure and scalable backend solutions, integrating APIs, authentication, and database management. My projects emphasize performance, reliability, and real-world impact."</p>
